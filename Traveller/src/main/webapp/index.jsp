...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg bg-azul-claro-degrade">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.html"><img class="header-logo" src="/icons/traveller-logo.svg"
            alt="Traveller"></a>
  ...
  <main>
    ...
    <section class="destino-search search">
      <input type="text" class="destino" placeholder="Digite seu destino" />
    ...
    <section>
      ...
      <div class="card nosso-card  mx-auto" style="width: 35rem;">
        ...
        <img src="/icons/pegadas.svg" class="icone-card mx-auto" alt="...">
        <div class="card-body">
          <p class="card-text text-center">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        </div>
      </div>
